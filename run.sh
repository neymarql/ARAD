...
torchrun --nproc_per_node=2  train_realnet.py --dataset MVTec-AD --class_name bottle
torchrun --nproc_per_node=2  train_realnet.py --dataset MVTec-AD --class_name cable
torchrun --nproc_per_node=2  train_realnet.py --dataset MVTec-AD --class_name capsule
torchrun --nproc_per_node=2  train_realnet.py --dataset MVTec-AD --class_name carpet
torchrun --nproc_per_node=2  train_realnet.py --dataset MVTec-AD --class_name grid
torchrun --nproc_per_node=2  train_realnet.py --dataset MVTec-AD --class_name hazelnut
torchrun --nproc_per_node=2  train_realnet.py --dataset MVTec-AD --class_name leather
torchrun --nproc_per_node=2  train_realnet.py --dataset MVTec-AD --class_name metal_nut
torchrun --nproc_per_node=2  train_realnet.py --dataset MVTec-AD --class_name pill
torchrun --nproc_per_node=2  train_realnet.py --dataset MVTec-AD --class_name screw
torchrun --nproc_per_node=2  train_realnet.py --dataset MVTec-AD --class_name tile
torchrun --nproc_per_node=2  train_realnet.py --dataset MVTec-AD --class_name toothbrush
torchrun --nproc_per_node=2  train_realnet.py --dataset MVTec-AD --class_name transistor
torchrun --nproc_per_node=2  train_realnet.py --dataset MVTec-AD --class_name wood
torchrun --nproc_per_node=2  train_realnet.py --dataset MVTec-AD --class_name zipper
